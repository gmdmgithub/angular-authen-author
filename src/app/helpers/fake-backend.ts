...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
      console.log('fake start', request, next);
        ...
        // admin
      const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkdyZWcgTSIsImVtYWlsIjoiZ3JlZ0BleGFtcGxlLmNvbSIsImFkbWluIjp0cnVlLCJleHAiOjE4NTE1MTg1NDQsInJvbGVzIjpbIkFETUlOIiwiSFIiXSwianRpIjoiNzcxYzA2NDMtNTg1ZC00ZDZlLWE1YWYtZmRjZmQwYjQzMGFlIiwiaWF0IjoxNTQxNTE4NTQ0fQ.e2LwCBUK7CkBxp2ckjEpykBt72RSm0JPzb8_o5JtJjk';
      // not admin
